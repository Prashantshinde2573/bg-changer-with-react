...
const App=()=>{
  ...
  return(
    <div className="bg-red-500 w-full h-screen duration-200 flex flex "style={{backgroundColor:color}}>
      ...
      <h2 className="m-auto">BACKGROUND CHANGER WITH HELP OF REACT !</h2>
